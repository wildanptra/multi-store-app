  ...
  void logIn() async {
    ...
    if(_formKey.currentState!.validate()){
      try {
        ...
        Navigator.pushNamedAndRemoveUntil(context, '/supplier_home', (route) => false);
                ...
                child: Form(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      processing ? const Center(child: CircularProgressIndicator(color: Colors.purple,)) : AuthMainButton(
